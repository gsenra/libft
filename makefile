...
#    Updated: 2020/02/11 17:27:34 by gsenra-a         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isascii.c ft_isdigit.c \
		...
		ft_strjoin.c ft_strtrim.c ft_substr.c ft_itoa.c ft_strmapi.c ft_putchar_fd.c \
...
OBJECTS = ft_atoi.o ft_bzero.o ft_calloc.o ft_isalnum.o ft_isascii.o ft_isdigit.o \
		...
		ft_substr.o ft_strjoin.o ft_strtrim.o ft_itoa.o ft_strmapi.o ft_putchar_fd.o \
